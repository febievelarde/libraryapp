      ...
      <div class="card-body">
          ...
          <form action="" method="POST"  >
              <div class="form-group">
                ...
                <input required  type="text" name="name" class="form-control" placeholder="Enter the title" value="<?= $course_year['name'] ?>">
              </div>
              <div class="form-group">
                <label>Course Year Slug</label>
                <input required  type="text" name="slug" class="form-control" placeholder="Enter the slug" value="<?= $course_year['slug'] ?>">
              </div>
