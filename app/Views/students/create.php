      ...
      <div class="card-body">
          ...
          <form action="" method="POST"  >
              <div class="form-group">
                ...
                <input required  type="text" name="student_id" class="form-control" placeholder="Enter the student id">
              </div>
              <div class="form-group">
                <label>Student Name</label>
                <input required  type="text" name="name" class="form-control" placeholder="Enter the student name">
              </div>
              ...
              <div class="form-group">
                ...
                <?php foreach ($course_years as $course_year) { ?>
                  <option value="<?= $course_year['id'] ?>"><?= $course_year['slug']; ?></option>
                <?php } ?>
                </select>
              </div>
